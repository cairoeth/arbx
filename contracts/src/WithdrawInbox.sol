...
/// @title WithdrawInbox
/// @author cairoeth
/// @notice A contract to initiate withdrawal requests for contracts tha provide liquidity to a Beacon contract.
contract WithdrawInbox is Ownable {
    ...
    function withdraw(
        ...
        emit WithdrawalRequest(
            _wdSeq, msg.sender, _receiver, _toChain, _fromChains, _tokens, _ratios, _slippages, _deadline
        );
    }
